...
public class NewAndReviewExamples {
	...
	public static void main(String[] args) {
		...
		switch(i) {
			...
			default: 	listOfObjectsayListExample();
					//break;
		}
	}
	...
	public static void listOfObjectsayListExample() {  //note that this is just a StringList, IntList, or CharList that we have already designed
